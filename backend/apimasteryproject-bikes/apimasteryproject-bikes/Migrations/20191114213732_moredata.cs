    ...
    public partial class moredata : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyColumn: "ID",
                keyValue: 1,
                columns: new[] { "Description", "Image", "Name", "Style" },
                values: new object[] { "On the bike leg of any triathlon, speed and efficiency win the game. The S-Works Shiv is the ultimate speed weapon for any triathlon distance, and it's purpose-built to take your bike leg to the next level.", "./docs/Images/Specializedsworksshiv.jpg", "S-Works Shiv", "TT" });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "Specialized is an independent US-based bike manufacturer that has been around for 40+ years. Specialized Bicycle Components, Inc., more commonly known simply as Specialized, is a major American brand of bicycles and related products. It was founded in 1974 by Mike Sinyard and is based in Morgan Hill, California.", "./docs/Images/Specializedlogo.jpg" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "Boone is our fastest, smoothest, lightest Cross bike ever, with competition-crushing race geometry and our exclusive course-smoothing IsoSpeed technology. Smooth and balanced. Front and Rear IsoSpeed make easy work of the roughest courses. These innovative decouplers reduce jarring impacts so you ride stronger, longer.", "./docs/Images/Trekboone.jpg", 2, "Boone", "Cyclocross" },
                    { 3, "SystemSix is truly in a class of its own. Newly crowned 2019 Race Bike of the Year by BikeRadar/Cycling Plus Magazine and the fastest bike tested by Tour Magazine.", "./docs/Images/Cannondalesystemsix.jpg", 3, "SystemSix", "Road" },
                    { 4, "After three years of intensive development, FOCUS have finally lifted the veil of secrecy and revealed the latest stage of mountain biking’s evolution. Alongside the FOCUS XC Team and Florian Vogel, this super-sized bike has come out of development and onto the market. Bike developers and pros stand united: this racing machine marks a milestone in mountain biking history. The Cloppenburg-based brand have once again redefined comfort, speed and grip.", "./docs/Images/Focusbigbird.jpg", 4, "Big Bird", "Mountain" },
                    { 5, "Hard and fast flat-course machine for aggressive athletes prepared to sacrifice comfort for all-out speed. Co-created five years ago by Andreas Walser, one of Europe’s top custom aero frame-builders, can the minimal-profile Focus Izalco Chrono 2.0 20-G still slice its way through the air and the competition?", "./docs/Images/Focusizalcochrono.jpg", 4, "Izalco Chrono", "TT" },
                    { 6, "The Sutra is many things. It's gorgeous. It's stylish. It's incredibly versatile, and it comes ready for the long haul on the bike tour of your dreams. Our Kona Cromoly steel frame is outfitted with a Brooks saddle, cork bar tape, BarCon shifters, fenders and rack.", "./docs/Images/Konasutra.jpg", 5, "KonaSutra", "Commuter" },
                    { 7, "Being one of our most versatile bikes in the lineup, it was a natural fit to take the suspension to the next level. ... If you need your bike to be a daily driver for your local trails as well as your bike park and shuttle session steed, the Patrol is the perfect choice.", "./docs/Images/Transitionpatrol.jpg", 6, "Patrol Carbon X01", "Mountain" }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Description", "Image", "Name", "Style" },
                values: new object[] { "Description", "Image", "Tarmac", "Road" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Description", "Logo" },
                values: new object[] { "Description", "Logo" });
        }
    }
}
